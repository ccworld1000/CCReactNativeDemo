  ...
  render() {
    return (
      <View style={styles.container}>
        ...
        <TouchableNativeFeedback onPress={this._onPressButton} backgroundColor={Platform.OS === 'android' ? TouchableNativeFeedback.SelectableBackground() : ''} underlayColor='white'>
          <View style={styles.button}>
